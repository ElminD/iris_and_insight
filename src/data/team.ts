...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    bio:
      ...
      '\n\n' +
      'Sareena has worked in the mental health field since 2012, serving in a variety of roles and gaining a wealth of knowledge and resources along the way. Sareena received her MSW from the University of Northern Iowa in 2024, she is currently practicing as an LISW. Sareena utilizes a variety of therapeutic approaches to support each individual in meeting their goals, including training in somatic-based approaches. Sareena believes that therapy should never be one-size-fits-all; instead, she tailors her approach to each client, helping them identify and work toward their own personal goals.' +
      '\n\n' +
