          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <Card>
              ...
              <div className="space-y-6">
                <div>
                  <p className="font-body text-xs font-semibold uppercase tracking-[0.18em] text-brand-teal mb-2">Email</p>
                  <a
                ...
                <div>
                  <p className="font-body text-xs font-semibold uppercase tracking-[0.18em] text-brand-teal mb-2">Phone</p>
                  <a
                ...
                <div>
                  <p className="font-body text-xs font-semibold uppercase tracking-[0.18em] text-brand-teal mb-2">Location</p>
                  <p className="font-body text-sm text-brand-charcoal-muted">Central Iowa</p>
                </div>
                <div>
                  <p className="font-body text-xs font-semibold uppercase tracking-[0.18em] text-brand-teal mb-2">Social Media</p>
                  <a
